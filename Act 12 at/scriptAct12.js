...
function Instrucciones(){ 
   swal("Instrucciones",
    "Aparecerán números del 1 al 9 aleatoriamente durante un segundo cada uno, después, aparecerá una pantalla con números donde el paciente deberá dar click en el orden en el que aparecieron los estímulos.");
}
