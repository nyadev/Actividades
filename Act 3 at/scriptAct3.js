...
circulo1.beginPath();
circulo1.arc(25,25,20,0,Math.PI*2,true);
circulo1.closePath();
circulo1.fill();

circulo2.fillStyle =color[1];
circulo2.beginPath();
circulo2.arc(25,25,20,0,Math.PI*2,true);
circulo2.closePath();
circulo2.fill();

circulo3.fillStyle =color[2];
circulo3.beginPath();
circulo3.arc(25,25,20,0,Math.PI*2,true);
circulo3.closePath();
circulo3.fill();

circulo4.fillStyle =color[3];
circulo4.beginPath();
circulo4.arc(25,25,20,0,Math.PI*2,true);
circulo4.closePath();
circulo4.fill();

circulo5.fillStyle =color[4];
circulo5.beginPath();
circulo5.arc(25,25,20,0,Math.PI*2,true);
circulo5.closePath();
circulo5.fill();

circulo6.fillStyle =color[5];
circulo6.beginPath();
circulo6.arc(25,25,20,0,Math.PI*2,true);
circulo6.closePath();
circulo6.fill();
