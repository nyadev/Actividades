...
function instrucciones(){
      swal(
   "Instrucciones",
    "Aquí el texto de las instrucciones Aparecerá un estímulo en el centro de un color determinado (Rojo, Azul o Verde) y forma determinado (Cuadrado, Círculo, Triángulo), en la siguiente pantalla aparecerá una nueva figura de igual o diferente color y/o forma, el paciente deberá dar click en la  en caso de ser el mismo o  en caso de ser diferente. El estímulo cambiará hasta que el paciente haya dado una respuesta.",
   );
}
