...
function validarIguales(valor){
    ...
    if(nivel===1){	
        ...
        if(idLetrota===0 && valor===1){
    		errores++;
    	alert("Error la Letra es una H  grande");
    	document.getElementById("errores").innerHTML=errores;
        }

        if(idLetrota===1 && valor===0){
            errores++;
        alert("Error la Letra es una S grande");
        document.getElementById("errores").innerHTML=errores;
        }
         if(aciertos===10){
               mostrarResultados();    
    ...
    if(nivel===2){  
        ...
        if(idLetrota===1 && valor===1){
            errores++;
        alert("Error, Has indicado que no es una S, cuando si lo es");
        document.getElementById("errores").innerHTML=errores;
        }

        if(idLetrota===0 && valor===0){
            errores++;
        alert("Error, Debes Elegir S grande");
        document.getElementById("errores").innerHTML=errores;
        }
         if(aciertos===10){
               mostrarResultados();    
